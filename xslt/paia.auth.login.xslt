            ...
            <body  onload="document.getElementById('account').focus();">
                ...
                <div id="contentwrapper">
                    ...
                    <div id="content">
                        ...
                        <form name="authzdienst" class="formnavi" method="get"><xsl:attribute name="action"><xsl:value-of select="$formURL"/></xsl:attribute>
                            <div>
                                ...
                                <input type="hidden" name="param"><xsl:attribute name="value"><xsl:value-of select="$redirectURL"/></xsl:attribute></input>
                                ...
                                <div>
                                    ...
                                    <input name="patronid" id="account" type="text" size="23" value="{$username}"/><br />
                                </div>
                                <div id="passwd">
