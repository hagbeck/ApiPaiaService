 ...
 */
public class PaiaHealthEndpoint extends HttpServlet {

    private String conffile  = "";
    private Properties config = new Properties();
    private Logger logger = Logger.getLogger(PaiaHealthEndpoint.class.getName());

    public PaiaHealthEndpoint() throws IOException {

        this("conf/api-test.properties");
    }

    public PaiaHealthEndpoint(String conffile) throws IOException {
        ...
        this.logger.info("Starting 'PaiaHealthEndpoint' ...");
